...
export default class RoomRenderer {
    ...
    constructor(room: Room) {
        ...
        this._intervalHandle = setInterval(this.Handle.bind(this), 16);
    ...
    private Draw() {
        ...
        /*
        // Draw avatars
        this._roomInstance.Avatars.forEach((avatar: Avatar, id: number) => {          
            
            this._context2d.drawImage(
                avatar.Animation.SpriteSheet,
                avatar.Animation.NextFrame().From.X,
                avatar.Animation.NextFrame().From.Y,
                avatar.Animation.NextFrame().To.X,
                avatar.Animation.NextFrame().To.Y,
                avatar.RenderPos.X,
                avatar.RenderPos.Y,
                avatar.Animation.NextFrame().To.X,
                avatar.Animation.NextFrame().To.Y
