    ...
    public static Register() {
        TabOwnComponent._component = Vue.component('tab-ownroom-c', {
            ...
            <div v-if="this.$parent.isSelected('ownrooms')" class="navigator-content">
                <h6><slot></slot></h6>
                <p v-if="this.$root.room_list.own.length == 0" class="navi-tip">We couldn't find any rooms for this category right now.</p>

                <div class="room-list-container">

                    <ul>
                   
                        <li v-for="room in this.$root.room_list.own">
